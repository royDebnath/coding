 ...
 *
 * Intuition:
 * The intuition behind this approach is that if there is a cycle in the graph, there will be at least one node that cannot be visited
 ...
 * outgoing edges one by one. If all the nodes are visited in the end, it means that it is possible to finish all the courses.
 */
public class Q45_CourseSchedule {
    ...
    public static boolean canFinish(int n, int[][] prerequisites) {
        ...
        /**
         * populate the adjacency list. Array's nth location  is the prereq course i.e n is the prereq. and the contents of the list

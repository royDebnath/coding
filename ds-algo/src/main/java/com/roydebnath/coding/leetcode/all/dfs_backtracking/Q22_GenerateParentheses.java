package com.roydebnath.coding.leetcode.all.dfs_backtracking;
 ...
 *
 * This ensures we never have an unmatched closing parenthesis.
 *
...
public class Q22_GenerateParentheses {
    ...
    private void generate(int openCount, int closeCount, String currentString) {
        ...
        if (openCount > maxPairs || closeCount > maxPairs || closeCount > openCount) {
